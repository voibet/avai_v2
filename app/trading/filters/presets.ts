          ...
          "or": [
            {
              "field": {
                "op": "divide",
                "left": { "op": "history", "left": "bookmakers.Pinnacle.fair_x12", "right": 300000 },
                "right": "bookmakers.Pinnacle.fair_x12"
              },
              "op": "gt",
              "value": 1.0
            },
            {
              "field": {
                "op": "divide",
                "left": { "op": "history", "left": "bookmakers.Betfair.fair_x12", "right": 300000 },
          ...
          "or": [
            {
              "field": {
                "op": "divide",
                "left": { "op": "history", "left": "bookmakers.Pinnacle.fair_ah_h", "right": 300000 },
            ...
            },
            {
              "field": {
                "op": "divide",
                "left": { "op": "history", "left": "bookmakers.Betfair.fair_ah_h", "right": 300000 },
            ...
            },
            {
              "field": {
                "op": "divide",
                "left": { "op": "history", "left": "bookmakers.Pinnacle.fair_ah_a", "right": 300000 },
            ...
            },
            {
              "field": {
                "op": "divide",
                "left": { "op": "history", "left": "bookmakers.Betfair.fair_ah_a", "right": 300000 },
    ...
    },
    {
      "and": [
        ...
        },
        {
          "function": "avg_per_line",
          "source": [
            { "op": "history", "left": "bookmakers.Pinnacle.fair_ou_o", "right": 300000 },
            { "op": "history", "left": "bookmakers.Betfair.fair_ou_o", "right": 300000 }
          ],
        ...
        },
        {
          "function": "avg_per_line",
          "source": [
            { "op": "history", "left": "bookmakers.Pinnacle.fair_ou_u", "right": 300000 },
            { "op": "history", "left": "bookmakers.Betfair.fair_ou_u", "right": 300000 }
          ],
          ...
          "or": [
            {
              "field": {
                "op": "divide",
                "left": { "op": "history", "left": "bookmakers.Pinnacle.fair_ou_o", "right": 300000 },
            ...
            },
            {
              "field": {
                "op": "divide",
                "left": { "op": "history", "left": "bookmakers.Betfair.fair_ou_o", "right": 300000 },
            ...
            },
            {
              "field": {
                "op": "divide",
                "left": { "op": "history", "left": "bookmakers.Pinnacle.fair_ou_u", "right": 300000 },
            ...
            },
            {
              "field": {
                "op": "divide",
                "left": { "op": "history", "left": "bookmakers.Betfair.fair_ou_u", "right": 300000 },
